...
<footer>
	<div class="footer-nav">
		<div class="footer-nav-left">
			<span class="footer-nav-text">서비스 이용약관</span> <span
				class="footer-nav-text">개인정보처리방침</span> <span
				class="footer-nav-text">영상정보처리기기 운영/관리 방침</span> <span
				class="footer-nav-text">위치기반서비스 이용약관</span> <span
				class="footer-nav-text">공지사항</span> <span class="footer-nav-text">임직원서비스</span>
		</div>
