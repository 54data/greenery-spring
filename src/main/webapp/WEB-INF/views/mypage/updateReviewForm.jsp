...
<!-- Modal --> 
<div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="reviewModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="reviewModalLabel">리뷰 수정</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <div class="modal-body">
                <div class="product-container">
                    <img src="loadMainImg?productId=${orderDetail.productId}" alt="" id="review_img">
...
*반품, 환불 관련 내용은 고객센터로 별도 문의해주세요.">${review.reviewContent}</textarea>
                ...
                <div>
                    ...
                    <div class="image-upload-container" onclick="document.getElementById('image-input').click();">
                        <div class="image-preview" id="image-preview">
							<c:choose>
							    <c:when test="${not empty review.reviewImgName}">
